...
import static com.ocadotechnology.gembus.test.Arranger.somePositiveInt;
...
public class PrintXmlResultsTest {
     ...
     * The class under test is a dammy class. Only the structure of xml file is tested.
     */
    @Test
    public void testHandleClass() {
        String className = "EmptyClass";
        String methodSignature = "method";
        int cc = somePositiveInt(100);
